...
fn default_line_height_cm() -> f64 { 0.8 }
...
mod tests {
    ...
    fn line_spacing_multipliers() {
        assert_eq!(LineSpacing::Normal.multiplier(), 1.4);
